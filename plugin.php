...
class FontAwesome {
    ...
    public function register_plugin_styles() {
        global $wp_styles;
        wp_enqueue_style('font-awesome-styles', '//netdna.bootstrapcdn.com/font-awesome/4.0.1/css/font-awesome.min.css', __FILE__, array(), self::VERSION, 'all');
    ...
    public function setup_shortcode($params) {
        ...
        return '<i class="' . sanitize_html_class( $name ) . '"><!-- ' . sanitize_html_class( $name ) . '--></i>';
    }
